...
const Navbar = () => {
  ...
  const storefrontUrl = "https://paystack.shop/lucky-smile"; // Replace with your actual Paystack storefront URL

  return (
    <nav className="p-4 fixed w-full top-0 z-50 bg-amber-200 text-gray-900 shadow-md">
      <div className="container mx-auto flex justify-between items-center">
        {/* Logo */}
        <div className="flex items-center space-x-2">
          <img
        ...
        <a
          ...
          className="hidden md:block bg-amber-600 text-white px-4 py-2 rounded-lg hover:bg-amber-700 transition-all"
        >
          Shop Now
        </a>
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="md:hidden mt-4 bg-amber-100 p-4 rounded-lg shadow-lg">
          <ul className="flex flex-col space-y-4">
            {navLinks.map((link) => (
              <li key={link.name}>
                <Link
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-4 block bg-amber-600 text-white px-4 py-2 rounded-lg text-center hover:bg-amber-700 transition-all"
          >
            Shop Now
          </a>
        </div>
